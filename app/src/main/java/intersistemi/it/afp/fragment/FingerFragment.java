...
public class FingerFragment extends Fragment
{
    ...
    private AudioFingerprinter fingerprinter = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState)
    {
        ...
        String pathBase= Environment.getExternalStorageDirectory().getPath() + File.separator + getString(R.string.app_name);
